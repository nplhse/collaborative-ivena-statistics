...
| Excel upload rejected on import form | `.xls` / `.xlsx` not supported (CSV-only importer) | Export as CSV (`.csv` or `.txt`); see [Import-workflow.md](Import-workflow.md#upload-validation) |
