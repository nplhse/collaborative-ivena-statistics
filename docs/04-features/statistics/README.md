...
| Top Lists | `/statistics/top-lists` | Catalog of ranked tables; detail routes under `/statistics/top-lists/{report}` (ranking depth Top 10–100 or All, page size 25/50/100, optional Scope/Period comparison) |
