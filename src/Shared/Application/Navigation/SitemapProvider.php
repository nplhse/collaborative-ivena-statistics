...
final readonly class SitemapProvider
{
    ...
    private const array ROUTE_LABELS = [
        ...
        'app_stats_insights' => ['labelKey' => 'link.stats.insights', 'labelDomain' => 'shared'],
        'app_stats_closed_department_assignments' => ['labelKey' => 'link.stats.closed_department_assignments', 'labelDomain' => 'shared'],
        ...
        'app_explore_state_list' => ['labelKey' => 'link.states', 'labelDomain' => 'shared'],
        'app_explore_hospital_list' => ['labelKey' => 'link.hospitals', 'labelDomain' => 'shared'],
        'app_explore_user_list' => ['labelKey' => 'link.users', 'labelDomain' => 'shared'],
        'app_explore_indication_list' => ['labelKey' => 'link.indications', 'labelDomain' => 'shared'],
        'app_explore_indication_group_list' => ['labelKey' => 'link.indication_groups', 'labelDomain' => 'shared'],
        'app_explore_infection_list' => ['labelKey' => 'link.infections', 'labelDomain' => 'shared'],
        'app_explore_glossary_index' => ['labelKey' => 'link.glossary', 'labelDomain' => 'shared'],
    ...
    private const array SECTIONS = [
        ...
        [
            ...
            'entries' => [
                ...
                ['route' => 'app_explore_state_list', 'visibility' => self::VISIBILITY_PARTICIPANT],
                ['route' => 'app_explore_hospital_list', 'visibility' => self::VISIBILITY_PARTICIPANT],
                ['route' => 'app_explore_user_list', 'visibility' => self::VISIBILITY_PARTICIPANT],
                ['route' => 'app_explore_indication_list', 'visibility' => self::VISIBILITY_PARTICIPANT],
                ['route' => 'app_explore_indication_group_list', 'visibility' => self::VISIBILITY_PARTICIPANT],
                ['route' => 'app_explore_infection_list', 'visibility' => self::VISIBILITY_PARTICIPANT],
                ['route' => 'app_explore_glossary_index', 'visibility' => self::VISIBILITY_PARTICIPANT],
        ...
        [
            ...
            'entries' => [
                ...
                ['route' => 'app_stats_insights', 'visibility' => self::VISIBILITY_AUTHENTICATED],
                ['route' => 'app_stats_closed_department_assignments', 'visibility' => self::VISIBILITY_AUTHENTICATED],
