...
class MciCase
{
    ...
    #[ORM\Column(nullable: true, enumType: AllocationGender::class)]
    ...
    #[ORM\Column(nullable: true, enumType: AllocationUrgency::class)]
    ...
    private ?string $mciId = null;

    #[ORM\Column(length: 255)]
    private ?string $mciTitle = null;
    ...
    public function getMciId(): ?string
    {
        return $this->mciId;
    }

    public function setMciId(string $mciId): static
    {
        $this->mciId = $mciId;
    ...
    public function getMciTitle(): ?string
    {
        return $this->mciTitle;
    }

    public function setMciTitle(string $mciTitle): static
    {
        $this->mciTitle = $mciTitle;
