...
final class AssignmentFactory extends PersistentProxyObjectFactory
{
    ...
    protected function defaults(): array
    {
         ...
         *
         * @var \Faker\Generator&\App\Allocation\Infrastructure\Faker\Provider\AssignmentFakerMethods $faker
         */
        $faker = self::faker();
    ...
    {
        self::faker()->addProvider(new \App\Allocation\Infrastructure\Faker\Provider\Assignment(self::faker()));
