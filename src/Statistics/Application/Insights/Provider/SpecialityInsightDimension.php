...
final readonly class SpecialityInsightDimension extends AbstractEntityInsightDimension
{
    #[\Override]
    public function key(): InsightDimensionKey
    {
        return InsightDimensionKey::Specialities;
    }
    ...
    {
        return 'stats.insights.dimension.specialities.label';
    }

    #[\Override]
    public function descriptionTranslationKey(): string
    {
        return 'stats.insights.dimension.specialities.description';
    }

    #[\Override]
    public function allValuesLinkTranslationKey(): string
    {
        return 'stats.insights.dimension.specialities.all';
    }

    #[\Override]
    public function icon(): string
    {
        return 'tabler:building-hospital';
    }
