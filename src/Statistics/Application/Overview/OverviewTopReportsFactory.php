    ...
    private function sections(): array
    {
        return [
            [
                ...
                'titleTranslationKey' => 'stats.top_lists.top_specialities.label',
                'labelColumnTranslationKey' => 'stats.top_lists.table.speciality',
            ...
            [
                ...
                'titleTranslationKey' => 'stats.top_lists.top_departments.label',
                'labelColumnTranslationKey' => 'stats.top_lists.table.department',
            ...
            [
                ...
                'titleTranslationKey' => 'stats.top_lists.top_assignments.label',
                'labelColumnTranslationKey' => 'stats.top_lists.table.assignment',
                'testId' => 'stats-overview-top-assignments',
            ],
            [
                'reportKey' => 'top_occasions',
                'batchKey' => OverviewTopEntitiesBatchQuery::DIMENSION_OCCASION,
                'titleTranslationKey' => 'stats.top_lists.top_occasions.label',
                'labelColumnTranslationKey' => 'stats.top_lists.table.occasion',
                'testId' => 'stats-overview-top-occasions',
            ],
            [
                'reportKey' => 'top_infections',
                'batchKey' => OverviewTopEntitiesBatchQuery::DIMENSION_INFECTION,
                'titleTranslationKey' => 'stats.top_lists.top_infections.label',
                'labelColumnTranslationKey' => 'stats.top_lists.table.infection',
            ...
            [
                ...
                'titleTranslationKey' => 'stats.top_lists.top_secondary_diagnoses.label',
                'labelColumnTranslationKey' => 'stats.top_lists.table.secondary_diagnosis',
