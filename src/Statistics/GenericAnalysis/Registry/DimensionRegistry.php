...
SQL;
    ...
    private function registerHospitalDimensions(): void
    {
        ...
        $enumTranslationKeys = static fn (string $prefix, array $cases): array => array_combine(
            ...
            array_map(static fn (\BackedEnum $case): string => $prefix.(string) $case->value, $cases),
        );
        ...
        $this->register(new AnalysisDimension(
            key: HospitalAnalysisConstants::POPULATION_GROUP_DIMENSION_KEY,
            ...
            valueLabelTranslationKeys: [
                HospitalAnalysisConstants::POPULATION_GROUP_PARTICIPATING => 'stats.generic_analysis.hospital_population.participating',
                HospitalAnalysisConstants::POPULATION_GROUP_NON_PARTICIPATING => 'stats.generic_analysis.hospital_population.non_participating',
            ],
            dataSource: $source,
        ));
    }
