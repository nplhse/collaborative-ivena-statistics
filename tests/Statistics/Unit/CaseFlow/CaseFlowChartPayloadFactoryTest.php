...
final class CaseFlowChartPayloadFactoryTest extends TestCase
{
    ...
    public function testCreateBuildsOriginBarAndMapPayload(): void
    {
    ...
    public function testCreateBuildsHospitalOriginBarPayload(): void
    {
        $result = new CaseFlowDashboardResult(
    ...
    public function testHospitalFlowDoesNotEnableDispatchAreaCompactPins(): void
    {
        ...
        self::assertNull($payload['geographicMap']['selectedSegment']);
        self::assertTrue($payload['geographicMap']['segmentSelectionEnabled']);
    }

    public function testCreateForwardsSelectedGeographicSegment(): void
    {
        $result = new CaseFlowDashboardResult(
            CaseFlowMode::HospitalOrigin,
            new CaseFlowKpiSet(12, 80.0, null, 25.0, 'Frankfurt', 100.0, 20.0, 10.0),
        ...
        $payload = $this->factory->create($result, GeographicSegment::travelTimeBand('10_20'));

        self::assertSame(
            ['type' => 'travel_time_band', 'id' => '10_20'],
            $payload['geographicMap']['selectedSegment'],
        );
        self::assertTrue($payload['geographicMap']['segmentSelectionEnabled']);
    }
}
